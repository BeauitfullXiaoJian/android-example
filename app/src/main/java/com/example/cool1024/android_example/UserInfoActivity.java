...
public class UserInfoActivity extends AppCompatActivity {
    ...
    private void loadSharedPreferences() {
        String avatarPath = mSharedPreferences.getString(getResources().getString(R.string.avatar), "NONE");
        ...
        if (requestCode == IMAGE_PICK_CODE && resultCode == RESULT_OK) {
            try {
                ...
                if (uri != null) {
                    ...
                    edit.putString(getResources().getString(R.string.avatar), uri.toString());
                    edit.apply();
                } else {
                    Log.e(TAG, "相册通信异常");
                }
